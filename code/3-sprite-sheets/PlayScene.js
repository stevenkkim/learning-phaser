export class PlayScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.spritesheet('grass', '/tilesets/grass.png', { frameWidth: 49, frameHeight: 49 });
        // this.load.image('grass', '/tilesets/grass.png');

        this.load.spritesheet('player', '/characters/player.png', { frameWidth: 49, frameHeight: 49 });
    ...
    create() {
        this.add.image(0, 0, 'grass').setOrigin(0, 0).setScale(2);
        this.add.tileSprite()
